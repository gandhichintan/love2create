...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        void InsertCustomerMisc(CustomerMisc customerMisc);

        void UpdateCustomerMisc(CustomerMisc customerMisc);

        CustomerMisc GetCustomerMiscByCustomerId(int customerId);

        void InsertRetailerProfile(RetailerProfile retailerProfile);
