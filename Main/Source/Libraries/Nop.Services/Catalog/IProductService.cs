...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<Bundle> GetAllBundles(bool showHidden = false);

        IList<Bundle> GetAllBundlesDisplayedOnHomePage();

        Bundle GetBundleById(int bundleId);

        IList<Bundle> GetBundlesByIds(int[] bundleIds);

        void InsertBundle(Bundle bundle);

        void UpdateBundle(Bundle bundle);

        IPagedList<Bundle> SearchBundles(string keywords,
            ProductSortingEnum orderBy, int pageIndex, int pageSize, bool showHidden = false);

        IList<Bundle> GetAllBundleProductsDisplayedOnHomePage();

        void UpdateBundleReviewTotals(Bundle bundle);

        #endregion

        #region Bundle pictures

        void DeleteBundlePicture(BundlePicture bundlePicture);

        IList<BundlePicture> GetBundlePicturesByBundleId(int bundleId);

        BundlePicture GetBundlePictureById(int bundlePictureId);

        void InsertBundlePicture(BundlePicture bundlePicture);

        void UpdateBundlePicture(BundlePicture bundlePicture);
        ...
        IPagedList<BundleProduct> GetBundleProductsByProductId(int productId, int pageIndex, int pageSize, bool showHidden = false);

        IList<BundleProduct> GetBundleProductsByBundleId(int bundleId, bool showHidden = false);

        BundleProduct GetBundleProductById(int bundleProductId);

        void InsertBundleProduct(BundleProduct bundleProduct);

        void UpdateBundleProduct(BundleProduct bundleProduct);

        IPagedList<BundleProduct> GetBundleProductsByBundleId(int bundleId, int pageIndex, int pageSize, bool showHidden = false);

        #endregion

        #region Bundle Project Mapping Methods

        void DeleteBundleProject(BundleProject bundleProject);

        IPagedList<BundleProject> GetBundleProjectsByProjectId(int projectId, int pageIndex, int pageSize, bool showHidden = false);

        IList<BundleProject> GetBundleProjectsByBundleId(int bundleId, bool showHidden = false);

        BundleProject GetBundleProjectById(int bundleProjectId);

        void InsertBundleProject(BundleProject bundleProject);

        void UpdateBundleProject(BundleProject bundleProject);

        IPagedList<BundleProject> GetBundleProjectsByBundleId(int bundleId, int pageIndex, int pageSize, bool showHidden = false);

        #endregion 

        #region Faqcategory mapping method

        Faq GetFaqCategoryById(int FaqCategoryId);

        IList<FaqCategory> GetFaqCategoryByHeadline(string Headline);

        IList<FaqCategory> GetAllFaqCategory(bool showHidden = false);

        IList<FaqCategoryMapping> GetFaqCatMapping(int FaqCatrgoryId);

        #endregion

        #region Product Faq Mapping Methods

        IList<ProductFaq> GetProductFaqsByProductId(int productId);

        ProductFaq GetProductFaqById(int productfaqid);

        void InsertProductFaq(ProductFaq productfaq);

        void UpdateProductFaq(ProductFaq productfaq);

        void DeleteProductFaq(ProductFaq productfaq);
        ...
        IPagedList<ProductVideo> GetProductVideosByVideoId(int videoId, int pageIndex, int pageSize, bool showHidden = false);

        IList<ProductVideo> GetProductVideosByProductId(int productId, bool showHidden = false);
        ...
        void DeleteProductLike(ProductLike productLike);

        IPagedList<Product> GetProductLikesByCustomerId(int customerId);

        void InsertProductLike(ProductLike productLike);

        ProductLike GetProductLikeByCustomerId(int customerId, int productId);

        int GetProductLikesByProductId(int productId);

        #endregion

        #region Aboutus

        IList<Trend> GetAllTrend(bool showHidden = false);

        IList<TrendReport> GetAllTrendReport(bool showHidden = false);

        //IList<MediaAboutus> GetAllMediaAboutus(bool showHidden = false);

        IList<CareerInformation> GetAllCareerInformation(bool showHidden = false);

        IList<CareerOpening> GetAllCareerOpenning(bool showHidden = false);

        //IList<MetaTags> GetAllMetaTags(bool showHidden = false);

        //IList<Subtopic> GetAllSubtopic(bool showHidden = false);

        IList<Site> GetAllSite(bool showHidden = false);

        IList<SiteContent> GetAllSiteContent(bool showHidden = false);

        //IList<JobLink> GetAllJobLink(bool showHidden = false);

        //IList<PageName> GetAllPageName(bool showHidden = false);

        IList<Safety> GetAllSafety(bool showHidden = false);

        IList<SafetyCategory> GetAllSafetyCategory(bool showHidden = false);
